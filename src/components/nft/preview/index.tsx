                ...
                <FormLayout>
                    <div className="relative flex justify-center">
                        ...
                        <div className="avatar absolute -top-1 -left-1">
                            <div className="w-10 h-10 ring-white/40 ring-offset-base-100 w-10 rounded-full ring-1 ring-offset-2 ">
                                <img
                    ...
                    <div className="flex-1 bg-transparent pt-6 flex flex-col justify-between">
                        <div>
                            ...
                            <div className="mt-1">
                                ...
                                <p className="mt-2 mb-3 text-base text-white/80 line-clamp-2">
                                    {data.description || "Đây là một sản phẩm độc đáo của chúng tôi"}
                                </p>
                            </div>
                        </div>
                        <div className="overflow-hidden mb-6">
                            <dl className="-mx-4 -mt-4 flex flex-wrap">
                                {[
                                    ...
                                    { label: "Số lượng", value: `1 trên ${data.totalSupply || 1}` },
