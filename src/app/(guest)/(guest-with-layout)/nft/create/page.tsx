"use client";
import { MintNftForm, PreviewNft, UploadNftMetaForm } from "@/components/nft-page";
  ...
  return (
    <div className="space-y-12">
      <div className="border-b border-white/60 pb-12">
        ...
        <p className="mt-1 text-base leading-6 text-white">Once your item is minted, you will not be able to change any of its information.</p>
      </div>
      <div className="pb-12">
        <PreviewNftProvider>
          <div className="flex flex-wrap-reverse justify-between items-center gap-y-4 lg:gap-x-4">
            ...
            <div className="box w-full lg:w-4/6 lg:flex-1">
              ...
              {account?.isConnectedWallet ? isTokenURI || tokenURI ? <MintNftForm tokenURI={tokenURI} /> : <UploadNftMetaForm setTokenURI={setTokenURI} /> : <ErrorAccount />}
            </div>
          </div>
        </PreviewNftProvider>
      </div>
