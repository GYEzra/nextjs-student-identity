...
const Subscribe = () => {
    return (
        <div className="relative isolate text-gray-600 body-font bg-gradient-to-r from-violet-600 via-purple-500 to-black py-16 ">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
                    <div className="max-w-xl lg:max-w-lg">
                        <h2 className="text-4xl font-semibold tracking-tight special-text">Subscribe to our newsletter</h2>
