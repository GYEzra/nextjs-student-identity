...
export declare namespace NftMarketplace {
  ...
  export type NFTStructOutput = [
    ...
    owner: string,
    isListed: boolean
  ] & { tokenId: bigint; price: bigint; owner: string; isListed: boolean };
}
...
export interface NftMarketplaceInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "_listedItemsCounter",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "_tokenIdsCounter",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export namespace NFTListedEvent {
  ...
  export type OutputTuple = [tokenId: bigint, price: bigint, owner: string];
  export interface OutputObject {
    tokenId: bigint;
    price: bigint;
    owner: string;
...
export interface NftMarketplace extends BaseContract {
  ...
  _listedItemsCounter: TypedContractMethod<[], [bigint], "view">;

  _tokenIdsCounter: TypedContractMethod<[], [bigint], "view">;
  ...
  mint: TypedContractMethod<
    [to: AddressLike, tokenURI: string, price: BigNumberish, isListed: boolean],
    [bigint],
    "payable"
  >;
  ...
  placeNftOnSale: TypedContractMethod<
    [owner: AddressLike, tokenId: BigNumberish, newPrice: BigNumberish],
    [void],
    "payable"
  >;
  ...
  tokenURIExists: TypedContractMethod<[tokenURI: string], [boolean], "view">;
  ...
  getFunction(
    nameOrSignature: "_listedItemsCounter"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
    nameOrSignature: "_tokenIdsCounter"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
  ...
  ): TypedContractMethod<[tokenURI: string], [boolean], "view">;
  getFunction(
  ...
  filters: {
    ...
    "NFTListed(uint256,uint256,address)": TypedContractEvent<
      NFTListedEvent.InputTuple,
      NFTListedEvent.OutputTuple,
      NFTListedEvent.OutputObject
    >;
